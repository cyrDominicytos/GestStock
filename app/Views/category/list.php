...
<?php $this->section('title'); echo  getenv('APP_NAME')."| ".productParams()[$type]["title"]; $this->endSection()?>
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> Gestion des <?= productParams()[$type]["externalName"] ?>s</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted text-capitalize"><?=  productParams()[$type]["externalName"]?>s</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-300 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark"><?=  productParams()[$type]["title"]?></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <!--end::Wrapper-->
                <!--begin::Button-->
                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#external_create_new" id="kt_toolbar_primary_button">Nouvelle <?= productParams()[$type]["externalName"] ?></a>
                <!--end::Button-->
            </div>
            <!--end::Actions-->
        </div>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Svg Icon-->Nouvelle <?= productParams()[$type]["externalName"]?></a>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                            ...
                            <?php $i = 1; foreach ($external as $user): ?>
                                <!--begin::Table row-->
                                    <tr>
                                        ...
                                        <td><?= $user[$tables.'_description']  ?></td>
                                        <td> 
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="" data-bs-toggle="modal" data-bs-target="#external_create_new" onclick="edit_external(<?=$user[$tables.'_id']  ?>,<?= $i ?>)" class="menu-link px-3"><i class="fa fa-edit text-primary py-2"> Editer</i></a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
...
<?= $this->section('javascript') ?>
    <script type="text/javascript">
        ...
        function edit_external(id, rowId) {
           ...
           document.getElementById("kt_modal_new_address_form").action = "<?= base_url() ?>"+"/product_category/edit";
           document.getElementById("externalID").value = id;
           document.getElementById("modalTitle").innerHTML = "Mise à jour d'une "+typeName;
           ...
           document.getElementById("description").value = table.rows[rowId].cells[2].innerHTML.trim();
