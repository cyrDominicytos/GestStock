...
-- Listage des données de la table inventory_manager.users : ~4 rows (environ)
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_at`, `updated_at`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `address`) VALUES
	(1, '127.0.0.1', 'administrator', '$2y$12$4ctWzUqPWzXqNfq2tUMXKeeUHeKZLdCk9qlCLBWfyy82P4GloraHy', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, '2022-02-03 18:20:41', '2022-02-04 12:12:28', 1643973148, 1, 'Admin', 'istrator', 'ADMIN', '65656565', 'Cotonou'),
